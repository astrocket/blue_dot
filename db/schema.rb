...
ActiveRecord::Schema.define(version: 2019_07_28_133807) do
  ...
  create_table "travelings", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["city_id"], name: "index_travelings_on_city_id"
    t.index ["world_id"], name: "index_travelings_on_world_id"
  end
  ...
  add_foreign_key "travelings", "cities"
  add_foreign_key "travelings", "worlds"
